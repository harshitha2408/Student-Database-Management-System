...
def login():
    ...
    elif usernameEntry.get()=="Harshitha" and passwordEntry.get()=='1234':
...
window.geometry('1286x736+0+0')
window.title('login system of sms')
...
usernameEntry = Entry(loginFrame, font=('times new roman', 20, 'bold'),bd=5,fg='red')
